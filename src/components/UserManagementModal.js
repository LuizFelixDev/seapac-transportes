...
import { X, Plus, Trash2, Edit3, User, Shield, Mail, Loader2, Check } from 'lucide-react';
        ...
        <div className="modal-body">
          ...
          <form onSubmit={handleSubmit} style={{ backgroundColor: 'hsl(var(--muted))', padding: '1rem', borderRadius: '12px', border: '1px solid hsl(var(--border))', marginBottom: '1.5rem' }}>
            <span style={{ fontSize: '0.75rem', fontWeight: 700, color: 'hsl(var(--primary))', textTransform: 'uppercase', display: 'block', marginBottom: '0.75rem', letterSpacing: '0.5px' }}>
              {editingId ? '✍️ Editar Usuário' : '➕ Cadastrar Novo Usuário Autorizado'}
            </span>
          ...
          <span style={{ fontSize: '0.75rem', fontWeight: 700, color: 'hsl(var(--muted-foreground))', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
            Lista de Usuários Autorizados ({users.length})
          </span>

          <div style={{ marginTop: '0.5rem', maxHeight: '250px', overflowY: 'auto', border: '1px solid hsl(var(--border))', borderRadius: '12px' }}>
            {loading ? (
